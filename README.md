...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/lingering-brook-f25d#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/lingering-brook-f25d
```

A live public deployment of this template is available at [https://lingering-brook-f25d.templates.workers.dev](https://lingering-brook-f25d.templates.workers.dev)
